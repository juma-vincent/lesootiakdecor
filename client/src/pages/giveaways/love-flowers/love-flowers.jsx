...
import "./love-flowers.scss";
import axios from 'axios';
import ProductItem from "../../../components/product-item/product-item";
import Spinner from "../../../components/spinner/spinner";


class LoveFlowersPage extends React.Component {
  state ={
    products: null
  }  
      ...
      <>
        ...
        (
         <div className="subcategory-products-page">           
            ...
            <h2 id='love-flowers-title'> Love ❤️🧡💛💚💙💜🖤🤍🤎 wins 👑🏆 </h2>

            <div id='love-flowers-description'>
...
export default LoveFlowersPage;
